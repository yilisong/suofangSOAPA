                    ...
                    <row>
                        ...
                        <i-col span="20">
                            <row class="physics-type">
                                ...
                                <i-col span="24" class="physics-tr-steal">防静电</i-col>
                        ...
                        <i-col span="24">
                            <row>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_e5b57a55f70856c81a40c7b525cdded6"></checkbox>
                                </i-col>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_7dcd3ba2d92770cdba20d75df2bcbf5d"></checkbox>
                                </i-col>
                            </row>
                        </i-col>
                        <i-col span="24">
                            <row>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_f651627d9cb8668b788f706d6b12261a"></checkbox>
                                </i-col>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_c0a693e717ad8db2f6ed592b0b9e40ff"></checkbox>
                                </i-col>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_5aa9876f4ea24e2a24b7d96f8e21f072"></checkbox>
                                </i-col>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_6d35ae7d9d07ce7faa68304494020ed8"></checkbox>
                                </i-col>
                            </row>
                        </i-col>
                        <i-col span="24">
                            <row>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_b84d9b4c81d8329fe18be2b2f598e0e2"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_58b5521a03185d6599ea2993039e2ec2"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_b4bbfa71b377eb9cf0f71f42bf3df76b"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_51c7164a29ed74e48bdb3f6f037a8d43"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_505d1423446b0a2b88f3183dd3f84eeb"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_5f66286097ae0d7c1ae4517215a886ce"></checkbox>
                                </i-col>
                            </row>
                        </i-col>
                        <i-col span="24">
                            <row>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_1e6ea84aff15e04530304c6c9a73d1b4"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_83fa74a1e7ed1f0db00c4700c6d59f3b"></checkbox>
                                </i-col>
                                <i-col span="24" class="physics-tr">
                                    <checkbox v-model="technology.tech_3_073853a7b1da359a4d43bd216e92861e"></checkbox>
                                </i-col>
                            </row>
                        </i-col>
                        <i-col span="24">
                            <row>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_afcf135789ccd6a479706cdf2436d88b"></checkbox>
                                </i-col>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_1b51dc2d4ed3bbe71728c25d7f6d0f76"></checkbox>
                                </i-col>
                                <i-col span="24" class="visit-tr">
                                    <checkbox v-model="technology.tech_3_54fa492902e364a6f551c0e093ec7729"></checkbox>
                                </i-col>
                            </row>
                        </i-col>
                        <i-col span="24">
